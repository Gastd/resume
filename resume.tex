...
\documentclass[a4paper, 10pt, roman]{moderncv}        % possible options include font size ('10pt', '11pt' and '12pt'), paper size ('a4paper', 'letterpaper', 'a5paper', 'legalpaper', 'executivepaper' and 'landscape') and font family ('sans' and 'roman')
\usepackage{textcomp}
% moderncv themes
...
\cvitem{Applications}{MatLab, \LaTeX{}, SolidWorks, MS Office, Eagle}

% \section{Computer skills}
% \cvdoubleitem{Languages}{C/C++, Python}{Fab skills}{Soldering, PCB printing, 3D printing}
% \cvdoubleitem{Frameworks}{Robot Operating System (ROS), GoogleTest, CMake}{Lab skills}{Soldering, PCB printing}
% \cvdoubleitem{Debugging}{GDB, Valgrind}{O.S.}{Linux (Ubuntu), Windows}
